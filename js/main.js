...
const scheduleInfo = {
    "前置工作坊": [
        {
            "08:30 ~ 09:00": "學員報到/各組相見歡",
            "09:00 ~ 10:00": "開場和破冰",
            "10:00 ~ 11:20": "演講",
            "11:30 ~ 12:00": "HCI intro",
            "12:00 ~ 13:00": "午餐",
            "13:10 ~ 14:00": "設計思考工作坊：同理、定義",
            "14:10 ~ 15:30": "演講",
            "16:00 ~ 17:00": "學員討論",
            "17:00 ~ 18:00": "晚餐",
            "18:10 ~ 19:10": "工具課程： Creative Coding",
            "19:10 ~ 20:30": "學員討論"
        },
        {
            "08:30 ~ 09:00": "學員報到",
            "09:10 ~ 10:40": "工具課程： SparkAR",
            "10:50 ~ 11:50": "設計思考工作坊：<br>發想、原型製作、測試",
            "12:00 ~ 13:00": "午餐",
            "13:10 ~ 14:40": "工具課程： Arduino",
            "14:50 ~ 15:40": "學員討論",
            "15:50 ~ 17:00": "小發表"
        }],
    "正式工作坊": [
        { 
            ...
            "16:30 ~ 17:00": "評審總評",
            "17:00 ~ 18:00": "晚餐",
            "18:00 ~ 20:00": "行業動態：<br>學長姐經驗分享座談會",
            "20:10 ~ 20:30": "學員討論"
        },
        {
            "08:30 ~ 09:00": "學員報到",
    ...
    for (const [key, value] of Object.entries(scheduleInfo)) {
        value.forEach((schedule, idx) => {
            ...
            if( (idx == 1 && key == "前置工作坊") || (idx == 2 && key == "正式工作坊") ){
                content +=  `<button type="button" class="cta_btn" style="max-height: 100%; margin:auto; margin-bottom:5%;" onclick="window.open('https://www.facebook.com/openhci/posts/pfbid02FaAdASoEsqW1BgxkgP9VwUQvSjYHDeGG7qDTGb2YbBtBfXApeNHNoh7GbbZFEgdyl')">錄取名單</button> `;
            }
            if( (idx == 1 && key == "正式工作坊") ){
